...
#define WM_AR_VIM_CLOSE_EDITOR  2538        // :q - ask AppRefiner/Application Designer to close the active editor (wParam=editor HWND)
#define WM_AR_VIM_SHOW_CHEATSHEET 2539      // :help - show Vim/AppRefiner cheatsheet (wParam=editor HWND)
